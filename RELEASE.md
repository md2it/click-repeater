...
7. Push the tag. GitHub Actions validates the tag, manifest, and CHANGELOG, runs the browser tests, builds `click-repeater.zip`, and publishes the GitHub Release.
...
`https://github.com/md2it/click-repeater/releases/latest/download/click-repeater.zip`
...
npm run build:extension -- \
  --extension-root ../click-repeater/extension \
  --output-zip /tmp/click-repeater.zip
```
...
2. Confirm that the GitHub Release is published, not a draft, and contains `click-repeater.zip`.
